...
This is a general style guide that shall govern over all **ReplaceColorPalette** project. The aim is
...
- You must always use relative imports for imports within the `replace_palette` library
